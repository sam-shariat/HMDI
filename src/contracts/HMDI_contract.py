...
class Product:
    ...
    def application_creation(self):
        return Seq([
            ...
            Assert(Txn.note() == Bytes("HMDI:uv002")),
            ...
            App.globalPut(self.Variables.donation,
                          Btoi(Txn.application_args[4])),
            App.globalPut(self.Variables.goaldonation,
    ...
    def donate(self):
        ...
        valid_payment_to_seller = And(
            ...
            Gtxn[1].amount() == App.globalGet(
                self.Variables.donation) * Btoi(count),
        ...
        update_state = Seq([
            App.globalPut(self.Variables.donated, App.globalGet(
                self.Variables.donated) + Btoi(count)),
            App.globalPut(self.Variables.uwallets, App.globalGet(
                self.Variables.uwallets) + Int(1)),
            Approve()
        ])
